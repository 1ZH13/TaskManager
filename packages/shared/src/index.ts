...
export const workActivitySchema = entity.extend({ workItemId: z.uuid(), actorId: z.uuid(), type: z.enum(['CREATED', 'UPDATED', 'ASSIGNED', 'MOVED', 'BLOCKED', 'EVIDENCE_SUBMITTED', 'COMMENTED']), message: z.string().min(1) });
